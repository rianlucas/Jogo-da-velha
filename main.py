...
print('Bem vindo ao jog oda velha')
print('Você vai jogar cotnra o computador')
...
def imprime_grid(grid):
    print('O status atual do grid é: \n')
...
while True:
    ...
    while grid[escolha - 1] != '_':
        print('Esta posição já foi selecionada, por favor selecione outro local')
        imprime_grid(grid)
        escolha = int(input('Qual é a sua escolha ?:'))
